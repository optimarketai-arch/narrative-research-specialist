...
**Timeline Integrity** — chronology, character ages, cause-and-effect sequencing, anachronisms

**Transitions** — chapter and scene flow, emotional continuity, pacing, information handoff

## How to Install
1. Create a new Claude Project at claude.ai/projects
2. Upload all files in this folder to Project Knowledge
3. Start a conversation — Claude is now your researcher
...
- rules.md — how it investigates
- examples.md — good vs. bad responses side by side
- reference/frameworks.md — risk matrix, timeline system, transition diagnostic, source tiers
- reference/source-guide.md — where to find authoritative sources by research type
- README.md — this file